...
def test_episode_initialisation():
    ...
    assert repr(episode1) == "<Episode 1: Venus' first episode in Podcast: <Podcast 1: 'Test1' by Venus>>"
    ...
    with pytest.raises(ValueError):
        episode1 = Episode("", podcast1, "Venus' first episode", "hello.com", "description", 5, "2017-12-27 00:50:29+00")
...
def test_episode_title_setter():
    ...
    assert repr(episode1) == "<Episode 1: 'Buzz the Buzzer' in Podcast: Podcast 1: TOY Story>"
    with pytest.raises(ValueError):
        episode1.title = 23
